...
"""autogenerated by genpy from stroll_bearnav/loadMapActionResult.msg. Do not edit."""
import sys
...
class loadMapActionResult(genpy.Message):
  _md5sum = "3e75cfde36d0b3f8d45ecbcb41696966"
  _type = "stroll_bearnav/loadMapActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','stroll_bearnav/loadMapResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(loadMapActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = stroll_bearnav.msg.loadMapResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = stroll_bearnav.msg.loadMapResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_f2i().pack(_x.result.distance, _x.result.numFeatures, _x.result.numMaps))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.distance, _x.result.numFeatures, _x.result.numMaps,) = _get_struct_f2i().unpack(str[start:end])
      return self
