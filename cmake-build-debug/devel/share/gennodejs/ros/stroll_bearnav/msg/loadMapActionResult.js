...
let loadMapResult = require('./loadMapResult.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class loadMapActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = loadMapResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new loadMapActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = loadMapResult.Resolve(msg.result)
    }
    else {
      resolved.result = new loadMapResult()
    }
...
module.exports = loadMapActionResult;
