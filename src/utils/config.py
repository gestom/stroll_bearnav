...
net_arg.add_argument("--mean_std_type", type=str, default="dataset",
...
def get_config(argv):
    ...
    config.data_dir = os.path.join(rospack.get_path("stroll_bearnav"), 'src', 'utils')
    config.temp_dir = os.path.join(rospack.get_path("stroll_bearnav"), 'src', 'Temp')
    config.scratch_dir = os.path.join(rospack.get_path("stroll_bearnav"), 'src', 'Temp')
    config.logdir = os.path.join(rospack.get_path("stroll_bearnav"), 'src', 'test')
