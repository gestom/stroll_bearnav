...
from spatial_transformer import transformer as transformer
from six.moves import xrange
from utils.test import eval_descs, eval_kps, loss_classification, loss_desc_non_pair, \
    loss_desc_pair, loss_desc_triplet, loss_overlap
from utils.layers import get_tensor_shape, make_theta
from utils.dump import image_summary_nhwc, show_all_variables
from utils.helper import get_patch_size, get_patch_size_no_aug
    ...
    def _build_module(self, module, inputs, bypass, names, skip, reuse=None,
        ...
        for name in names:
            ...
            if not is_first:
                ...
                cur_reuse = reuse
            with tf.variable_scope(module, reuse=tf.AUTO_REUSE) as sc:
