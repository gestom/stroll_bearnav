...
'results/Map_experiences.srt' using 1:(1-$0/960) with lines title "Experiences map:  gradual adaptation to changes" lw 1,\
'results/Map_privileged.srt' using 1:(1-$0/960) with lines title "Privileged map:  gradual adaptation to changes" lw 1,\
